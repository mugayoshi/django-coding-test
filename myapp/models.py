...
class ContentFile(models.Model):
    content: models.ForeignKey = models.ForeignKey(Content, on_delete=models.CASCADE, related_name='files')
    file: models.FileField = models.FileField(upload_to='content_files/')
...
class Channel(models.Model):
    title: models.CharField = models.CharField(max_length=255)
    language: models.CharField = models.CharField(max_length=100)
    picture: models.ImageField = models.ImageField(upload_to='channel_pictures/', blank=True, null=True)
